...
//                       child: TextButton(
//                         onPressed: () => authProvider.resetPassword(emailController.text.trim(), context),
...
//                           authProvider.loginWithEmail(emailController.text.trim(), passwordController.text.trim(), context);
//                         }
//                       },
                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            const Color.fromARGB(255, 215, 170, 170),
                        padding: const EdgeInsets.symmetric(
                            horizontal: 40, vertical: 15),
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(12)),
